...
class OdometryNode:
    # Set publishers
    pub_odom = rospy.Publisher('/robot_1/odom', Odometry, queue_size=1)
    ...
    def sub_robot_pose_update(self, msg):
        ...
        try:
            arrayIndex = msg.name.index('robot_1::base_link')
            # rospy.loginfo("--------------------")
            # rospy.loginfo("msg.name: %s", msg.name)
            # rospy.loginfo("robot_1--self.last_received_pose: %s", self.last_received_pose)
    ...
    def timer_callback(self, event):
        ...
        cmd.header.frame_id = 'robot_1/odom'
        cmd.child_frame_id = 'robot_1/base_link'
