...
class OdometryNode:
    # Set publishers
    pub_odom = rospy.Publisher('/robot_3/odom', Odometry, queue_size=1)
    ...
    def sub_robot_pose_update(self, msg):
        ...
        try:
            arrayIndex = msg.name.index('robot_3::base_link')
    ...
    def timer_callback(self, event):
        ...
        cmd.header.frame_id = 'robot_3/odom'
        cmd.child_frame_id = 'robot_3/base_link'
...
if __name__ == '__main__':
    rospy.init_node("gazebo_odometry_node_robot3")
    node = OdometryNode()
    rospy.spin()
